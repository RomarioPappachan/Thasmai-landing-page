        ...
        <div className='w-full py-4 flex flex-col items-end gap-[14px]'>
            ...
            >
                ...
                <div className='hidden md:block h-full'>
                    ...
                    >
                        <p className='font-bold text-base'>Thasmai</p>
                        {props.section === "section1" && <a 
            ...
            >
                ...
                <div className='hidden md:block h-full'>
                    ...
                    >
                        <p className='font-bold text-base'>SMS Meditation</p>
            ...
            >
                ...
                <div className='hidden md:block h-full'>
                    ...
                    >
                        <p className='font-bold text-base'>Thasmai Solutions</p>
            ...
            >
                ...
                <div className='hidden md:block h-full'>
                    ...
                    >
                        <p className='font-bold text-base'>Blogs & Articles</p>
            ...
            >
                ...
                <div className='hidden md:block h-full'>
                    <div 
                        id='sectionName5'
                        className={
                            props.section === "section5" ? 'h-full ps-2 py-2 flex flex-col link-show' : 'h-full ps-2 py-2 flex flex-col justify-center'
                        }
                    >
                        <p className='font-bold text-base'>Digital Library</p>
                        {props.section === "section5" && <a 
                            className='w-[133px] h-[32px] text-sm  font-semibold font-sans rounded-lg bg-[#A1B53A] text-[#2C3400] flex justify-center items-center'
                            href='https://thasmai.tstsvc.in/'
                            target='_blank'
                            >
            ...
            >
                ...
                <div className='hidden md:block h-full'>
                    ...
                    >
                        <p className='font-bold text-base'>Films & Documentaries</p>
