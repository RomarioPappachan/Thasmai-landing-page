...
function AskQuestion(props) {
    return (
        <div className='z-30 m-0 px-2 md:p-0 w-screen min-h-screen bg-[rgba(0,0,0,0.74)] backdrop-blur-sm flex justify-center items-center fixed top-0 left-0'>
            {/* Close button */}
            <div 
                className='size-10 text-5xl text-white bg-[rgba(0,0,0,0.42)] rounded-full flex justify-center items-center rotate-45 absolute top-10 right-10 cursor-pointer'
                onClick={() => {
