...
function Thasmai() {
    return (
        <div className='w-full h-full bg-white opacity-100 animate-fade-in-glow'>
            <div className='w-full md:w-[80%] px-4 md:px-0 md:ps-16 flex flex-col md:flex-row'>
                <div className='w-full md:w-[45%] pt-10 md:pt-20'>
                    ...
                    <p className='w-[75%] md:w-full mt-5 text-xs md:text-xl font-normal leading-5 md:leading-8'>
