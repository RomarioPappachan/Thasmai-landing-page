...
function AboutUs() {
    return (
        <main className="w-full min-h-screen m-0 p-0">
			...
			<div className='w-full lg:h-screen pt-[132px] pb-11 px-4 sm:px-12  lg:px-16 bg-[#372F26] flex flex-col lg:flex-row justify-center'>

				<div className='w-full lg:w-[60%] h-full lg:pe-10 flex flex-col justify-between'>
					{/* ------About Us------- */}
					<div className='w-full lg:h-[264px] ps-8 pe-24 py-8 bg-[#211B12] text-white'>
						<h3 className='text-2xl leading-8 text-white'>About us</h3>
						<p className='text-sm leading-6'>
							Thasmai is a world revolutionary project, to rehabilitate the world as a single <br /> 
							entity as envisioned by the creator.
						</p>

						<h3 className='mt-8 text-2xl leading-8 text-white'>Follow us</h3>
					...
					<div className='w-full lg:h-[264px] px-8 py-8 bg-[#211B12]'>
						<h3 className='text-2xl leading-8 text-white'>Contact us</h3>
				...
				<div className='w-full lg:w-[40%] flex flex-col justify-between'>
					<h3 className='my-3 lg:m-0 text-2xl leading-8 text-white'>Map Location</h3>
